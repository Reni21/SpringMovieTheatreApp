function pinMovie(form, event, moviesToPin, submitFormHandler) {
    ...
    $.each(movieIds, function (index, value) {
        ...
        var link = '<div id="' + value + '"><div class="wrapper">' +
            ...
            '<com.theatre.movie.form action="schedule?date=' + date + '"' +
            ' class="session-com.theatre.movie.form" name="session-com.theatre.movie.form" id="session-form_' + value + '" method="post">' +
